...
import static com.mlieshoff.build.essentials.ChangeLogVersionChecker.main;
...
class ChangeLogVersionCheckerTest {
    ...
    void main_whenWithChangeLogInconsistentHead_thenThrowException() {
        ...
        assertThatIllegalStateException()
                ...
                .withMessage(
                        "Versions in './src/test/resources/CHANGELOG_inconsistent_head.md' are not"
                                + " matching, reason: head");
    }
    ...
    void main_whenWithChangeLogInconsistentTitle_thenThrowException() {
        ...
        assertThatIllegalStateException()
                ...
                .withMessage(
                        "Versions in './src/test/resources/CHANGELOG_inconsistent_title.md' are not"
                                + " matching, reason: title");
    }
    ...
    void main_whenWithChangeLogInconsistentCurrent_thenThrowException() {
        ...
        assertThatIllegalStateException()
                ...
                .withMessage(
                        "Versions in './src/test/resources/CHANGELOG_inconsistent_current.md' are"
                                + " not matching, reason: tag");
    }
